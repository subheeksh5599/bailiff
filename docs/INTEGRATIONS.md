...
| 4 | Grading | a second evaluator scores the same call; stored next to our checks | `SCORECARD_API_KEY` | skipped, and any failure is recorded as `grade.independent_failed`; the gate still uses our own checks |
